...
public class ActivityTambahMhs extends AppCompatActivity{
    ...
    private void insertData() {
        ...
        database = FirebaseDatabase.getInstance("https://praktikum-firebase-b8ba1-default-rtdb.firebaseio.com/");
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nim.equals("") || nama.equals("") || jurusan.equals("") || angkatan.equals("")){
                    Toast.makeText(ActivityTambahMhs.this, "Data Harus diisi semua!!", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    myref.child(nim).setValue(mhs).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(ActivityTambahMhs.this, "Data berhasil ditambahkan", Toast.LENGTH_SHORT).show();
                            etNIM.setText("");
                            etNama.setText("");
                            etJurusan.setText("");
                            etAngkatan.setText("");
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(ActivityTambahMhs.this, "Data Gagal ditambahkan", Toast.LENGTH_SHORT).show();
                        }
                    });
                    finish();
                }
