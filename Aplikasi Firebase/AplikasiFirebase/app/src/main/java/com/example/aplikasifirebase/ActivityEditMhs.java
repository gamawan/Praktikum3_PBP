...
public class ActivityEditMhs extends AppCompatActivity {
        ...
        if(!nim.equals(temp_nim) || !nama.equals(temp_nama) || !jurusan.equals(temp_jurusan)|| !angkatan.equals(temp_angkatan)){
            ...
            databaseReference.setValue(mahasiswa).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(ActivityEditMhs.this, "Data berhasil diubah", Toast.LENGTH_SHORT).show();
                    etNIM.setText("");
                    etNama.setText("");
                    etJurusan.setText("");
                    etAngkatan.setText("");
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(ActivityEditMhs.this, "Data gagal diubah", Toast.LENGTH_SHORT).show();
                }
            });
        }
        else{
