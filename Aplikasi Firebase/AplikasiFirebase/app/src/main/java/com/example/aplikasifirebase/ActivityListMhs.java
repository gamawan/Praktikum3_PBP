...
public class ActivityListMhs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        startActivity(new Intent(ActivityListMhs.this,ActivityEditMhs.class).putExtra("nim",nim));
                    }
                });
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ActivityListMhs.this, "Maaf Terjadi kesalahan... coba beberapa saat lagi!", Toast.LENGTH_SHORT).show();
            }
        });
